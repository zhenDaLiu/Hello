 ...
 * 雪花算法生成id
 * @author 风又奈何
 * @link https://www.cnblogs.com/yanduanduan/p/10038345.html
 */
public class SnowFlakeGenerator {
    ...
    public static SnowFlakeGenerator getInstance(){
        if(snowFlakeGenerator == null){
            snowFlakeGenerator = new Factory().create();
        }
     ...
     * 数据中心
     */
    private static final String CENTER_CODE = System.getProperty("ytx.center.num");
    /**
     * 实例编码
     */
    private static final String MACHINE_CODE = System.getProperty("ytx.instance.num");
    ...
    public static class Factory {
        ...
        public SnowFlakeGenerator create() {
            if(CENTER_CODE != null && MACHINE_CODE != null){
                return new SnowFlakeGenerator(this.idcBitNum, this.machineBitNum, Long.parseLong(CENTER_CODE), Long.parseLong(MACHINE_CODE));
            }
            throw new RuntimeException("未在环境变量中配置中心编码或实例编码，请确认！");
        }
    }
     ...
     * 可分配的位数
     */
    private final static int REMAIN_BIT_NUM = 15;
